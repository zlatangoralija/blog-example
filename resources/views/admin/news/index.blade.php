                                    ...
                                    @foreach($news as $singleNews)
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <a rel="tooltip" class="btn btn-success btn-link" href="{{route('admin.news.edit', $singleNews->id)}}" data-original-title="" title="">
                                                ...
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.news.destroy',$singleNews->id], 'class' => 'hidden', 'id'=>"delete-".$singleNews->id]) !!}
                                                {!! Form::close() !!}
                                            </td>
                                        </tr>
                                    @endforeach
